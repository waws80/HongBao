package thanatos.hongbao.services;
...
import thanatos.hongbao.utils.HongbaoSignature;
import thanatos.hongbao.utils.PowerUtil;
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
       switch (event.getEventType()){
           case AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED:
               for (CharSequence str:event.getText()) {
                   Log.w(TAG, "onAccessibilityEvent: "+ str);
                   if (str.toString().contains("QQ红包")){
                       //模拟打开通知栏消息
